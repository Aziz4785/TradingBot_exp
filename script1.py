...
percentages = df[['to_buy_1d','to_buy_1d31']].mean() * 100
            ...
            for coef3 in np.arange(0, 1.1, 0.1):
                ...
                for coef4 in np.arange(0, 1.1, 0.1):
                    for coef5 in np.arange(0, 1.1, 0.1):
                        if coef1+coef2+coef3+coef4+coef5>=1.4 or coef1+coef2+coef3+coef4+coef5<=0.4 : 
                            continue               
                        if singlecoef5:
                            continue
                        ...
                        if coef1+coef2+coef3+coef4 <=0.001 and coef5>=0.1:
                            singlecoef5=True
